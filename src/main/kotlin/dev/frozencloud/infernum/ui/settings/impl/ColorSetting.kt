...
import dev.frozencloud.infernum.util.render.Color.Companion.hsbMax
...
import dev.frozencloud.infernum.util.ui.TextInputHandler
import dev.frozencloud.infernum.util.ui.animations.EaseInOutAnimation
import dev.frozencloud.infernum.util.ui.rendering.Gradient
...
class ColorSetting(
    ...
    override fun render(x: Float, y: Float, right: Float, mouseX: Float, mouseY: Float): Float {
        ...
        NanoVGHelper.hollowRect(inputX, inputY, HEX_INPUT_WIDTH, 18f, 1f, if(textInputHandler.listening) Colors.InfernumAccent.rgba else Colors.Border.rgba, 4f)
