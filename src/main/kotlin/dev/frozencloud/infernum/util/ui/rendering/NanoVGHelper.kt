...
import dev.frozencloud.infernum.util.render.Color.Companion.alpha
import dev.frozencloud.infernum.util.render.Color.Companion.blue
import dev.frozencloud.infernum.util.render.Color.Companion.green
import dev.frozencloud.infernum.util.render.Color.Companion.red
...
object NanoVGHelper {
    val defaultFont = Font("Default", mc.resourceManager.getResource(ResourceLocation.parse("${Infernum.MOD_ID}:font.ttf")).get().open())
