...
import dev.frozencloud.infernum.util.render.Color.Companion.darker
import dev.frozencloud.infernum.util.render.Color.Companion.hover
...
object Colors {
    ...
    // Base theme - Infernum Magma (Main Accent)
    @JvmField val InfernumAccent = Color(255, 85, 0)           // #ff5500   vibrant lava orange
    @JvmField val InfernumAccentLight = Color(255, 140, 65)    // #ff8c41   bright glow / ember
    @JvmField val InfernumAccentDark = Color(180, 40, 0)       // #b42800   hardened magma

    // Backgrounds - Obsidian & Ash
    @JvmField val Background = Color(18, 14, 12)               // #120e0c   deep charcoal-brown
    @JvmField val Surface = Color(28, 22, 20)                  // #1c1614   sooty surface
    @JvmField val SurfaceElevated = Color(41, 32, 28)          // #29201c   lighter ash/stone
    @JvmField val Border = Color(64, 45, 38)                   // #402d26   burnt earth divider

    // Text - Ember & Ash
    @JvmField val TextPrimary = Color(255, 235, 225)           // #ffebe1   warm white (heat haze)
    @JvmField val TextSecondary = Color(200, 160, 145)         // #c8a091   muted clay/sand
    @JvmField val TextMuted = Color(125, 95, 85)               // #7d5f55   dimmed soot

    // Semantic / feedback colors
    @JvmField val Success = Color(165, 225, 60)                // #a5e13c   toxic green / sulfur
    @JvmField val Warning = Color(255, 180, 0)                 // #ffb400   gold/flame
    @JvmField val Error = Color(230, 40, 40)                   // #e62828   intense blood red

    // Disabled states
    @JvmField val DisabledBackground = Color(45, 38, 36)       // #2d2624
    @JvmField val DisabledContent = Color(90, 80, 75)          // #5a504b

    // Derived versions
    @JvmField val InfernumAccentHover = InfernumAccent.hover(1.25f)
    @JvmField val GlacialAccentBrighter = InfernumAccent.brighter(1.4f)
    @JvmField val GlacialAccentDarker = InfernumAccent.darker(0.65f)
    @JvmField val SurfaceHover = SurfaceElevated.brighter(1.15f)
    @JvmField val BackgroundDarker = Background.darker(0.8f)
}