...
import dev.frozencloud.infernum.util.overlay.OverlayManager.overlays
...
object OverlayEditor : Screen(Component.literal("Frozen overlay editor")) {
    ...
    override fun render(context: GuiGraphics, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        overlays.forEach {
            ...
            val color = if (it.dragging || it == OverlayManager.getHoveredOverlay(mouseX.toFloat(), mouseY.toFloat())) Colors.InfernumAccent.rgba else Colors.WHITE.rgba
