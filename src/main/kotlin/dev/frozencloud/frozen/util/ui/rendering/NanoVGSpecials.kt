...
class NanoVGSpecials(vertexConsumers: MultiBufferSource.BufferSource) : PictureInPictureRenderer<NanoVGSpecials.NVGRenderState>(vertexConsumers) {
    override fun renderToTexture(state: NVGRenderState, poseStack: PoseStack) {
        ...
        NanoVGHelper.beginFrame(width.toFloat(), height.toFloat())
        state.renderContent()
