...
class KeybindSetting(
    ...
    override fun render(x: Float, y: Float, right: Float, mouseX: Float, mouseY: Float): Float {
        ...
        NanoVGHelper.text(NanoVGHelper.defaultFont, value.displayName.string, rectX + RECT_PADDING, rectY + HEIGHT / 2f - 8f, 16f, if (listening) Colors.InfernumAccent.rgba else Colors.TextPrimary.rgba)
